...
function CornerThemeToggle() {
  ...
  return (
    <button onClick={toggleTheme} className="btn-ghost p-2 rounded-xl absolute top-4 right-4"
      ...
      {isDark
        ? <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="5" /><path strokeLinecap="round" d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4" /></svg>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-warm-bg relative">
      ...
      <div className="w-full max-w-sm animate-fade-up">
        <div className="text-center mb-8">
          <div className="w-19 h-12 mx-auto rounded-2xl bg-brand-600 text-white flex items-center justify-center font-bold text-lg shadow-soft"></div>
